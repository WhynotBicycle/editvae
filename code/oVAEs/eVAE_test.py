...
# from sVAEs_module_novis_similarity_back import TrainSVAE
...
# sys.path.append('/home/shidi/scripts/neural_parts/similarity/dataloader')
# from dl import BenchmarkDataset, BenchmarkDatasetOnTheFly
...
vae = TrainSVAE(beta=5e-3, batch_size=batch_size, epoch=1000,
                train_loader=train_loader, test_loader=test_loader,
                category = category, device=device, ppl=True, n_parts=4,
                sp_reg_terms=sp_reg_terms, m_samples=False,
                train_rate=1, use_realNVP=True, multi_NVP=True, symmetry=False)
